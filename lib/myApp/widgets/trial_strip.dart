// Animated "7 days free" trial strip. Ported from the prototype's
// <TrialStrip>: entry rise + spring-popped "7" badge, a pulsing ring, and a
// light sweep that crosses the card on a loop. Honours the platform
        ...
        child: DecoratedBox(
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [Color(0x1F1D4ED8), PwtColors.surface],
              stops: [0, .7],
            ),
          ),
          child: Stack(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            s['trialTitle']!,
                            style: PwtType.title().copyWith(fontSize: 14.5, fontWeight: FontWeight.w700, letterSpacing: -.25),
                          ),
                          const SizedBox(height: 2),
                          Text(
                            s['trialSub']!,
                            style: PwtType.body(color: PwtColors.textSec).copyWith(fontSize: 12, height: 1.4),
                          ),
                        ],
                      ),
                    ),
        ...
        children: [
          ...
          AnimatedBuilder(
            ...
            child: Container(
              ...
              height: 42,
              alignment: Alignment.center,
              decoration: BoxDecoration(color: PwtColors.brand, borderRadius: BorderRadius.circular(13)),
              child: Text(
                '7',
                textDirection: TextDirection.ltr,
                style: PwtType.mono(color: PwtColors.textInv).copyWith(fontSize: 19, fontWeight: FontWeight.w700),
              ),
            ),
          ),
        ],
