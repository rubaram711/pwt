        ...
        children: [
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
                ...
                child: const Icon(Icons.calendar_today_outlined, size: 22, color: _C.blue700)),
          ...
          ...['Personalized product recommendation', 'Pricing & rental options', 'Installation & after-sales support', 'For homes & businesses']
              .map((t) => Padding(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: Text(t, style: const TextStyle(fontSize: 13.5, color: _C.ink700))),
            ]),
          )),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text('Schedule a Call', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600)),
                SizedBox(width: 9),
